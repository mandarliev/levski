...
// 2. Increase the height of the header
// 2. Make it responsive
// 3. Set a darkening effect on the top

const coaches = [
  {
    name: "Konstantin Nikolov",
    description: "BJJ / Grappling",
    href: "#",
    icon: HomeIcon,
  },
  {
    ...
    <header className="bg-[#013B94]">
      <nav className="mx-auto flex max-w-8xl items-center justify-between p-6 lg:px-8">
        <div className="flex lg:flex-1">
          ...
          <h1 className="text-white ml-6 mt-3">Levski Sofia Fight Club</h1>
        </div>
      ...
      >
        ...
        <Dialog.Panel className="fixed inset-y-0 right-0 z-10 w-full overflow-y-auto bg-[#013B94] px-6 py-6 sm:max-w-sm sm:ring-1 sm:ring-gray-900/10">
          <div className="flex items-center justify-between">
            ...
            <h1 className="text-white">Levski Sofia Fight Club</h1>
            <button
              type="button"
